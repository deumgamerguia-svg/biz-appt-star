...
export const Route = createFileRoute("/_authenticated/painel/pagamentos")({
  head: () => ({
    meta: [
      { title: "Pagamentos â€” Agenda Agora­" },
      { name: "description", content: "Meses em que a assinatura da agenda foi paga." },
      { property: "og:title", content: "Pagamentos â€” Agenda Agora­" },
      { property: "og:description", content: "HistÃ³rico de pagamentos da assinatura." },
    ],
  }),
